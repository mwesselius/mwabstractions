...
,
		"rect" : [ 627.0, 95.0, 467.0, 500.0 ],
		"bglocked" : 0,
		"defrect" : [ 627.0, 95.0, 467.0, 500.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 45.0, 62.0, 29.0 ],
					"text" : "test for double-click"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 150.0, 23.5, 18.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 360.0, 120.0, 36.0, 20.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 360.0, 90.0, 41.0, 20.0 ],
					"text" : "< 240"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 360.0, 60.0, 37.0, 20.0 ],
					"text" : "timer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 30.0, 80.0, 29.0 ],
					"text" : "set ctrl number through inlet"
				}

			}
, 			{
				"box" : 				{
					"comment" : "set ctrl number",
					"id" : "obj-3",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 255.0, 76.0, 52.0 ],
					"text" : "set default\nctrl number with an argument"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 210.0, 30.0, 45.0, 30.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 54.5, 309.0, 84.5, 309.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 369.5, 309.0, 84.5, 309.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 219.5, 66.0, 294.5, 66.0, 294.5, 20.0, 369.5, 20.0 ],
					"source" : [ "obj-6", 0 ]
				}
